...
systemDictionary = {
	"wizconnect adapter settings": {
		...
		"ru": "Настройки адаптера для wizconnect",
		"pt": "Configurações do adaptador para wizconnect",
		"nl": "Adapterinstellingen voor wizconnect",
		"fr": "Paramètres de l'adaptateur pour wizconnect",
		"it": "Impostazioni dell'adattatore per wizconnect",
		"es": "Configuración del adaptador para wizconnect",
		"pl": "Ustawienia adaptera dla wizconnect",
		"zh-cn": "wizconnect 的适配器设置"
	},
	"active":      {
		"en": "Active",
		"de": "Aktiv",
